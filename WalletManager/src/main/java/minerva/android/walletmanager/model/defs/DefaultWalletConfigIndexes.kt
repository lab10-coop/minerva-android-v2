...
annotation class DefaultWalletConfigIndexes {
    companion object {
        ...
        const val FIRST_DEFAULT_TEST_NETWORK_INDEX = 0
        const val SECOND_DEFAULT_TEST_NETWORK_INDEX = 1
        const val THIRD_DEFAULT_TEST_NETWORK_INDEX = 2
        const val FOURTH_DEFAULT_TEST_NETWORK_INDEX = 3
        const val FIFTH_DEFAULT_TEST_NETWORK_INDEX = 4
        const val FIRST_DEFAULT_MAIN_NETWORK_INDEX = 0
        const val SECOND_DEFAULT_MAIN_NETWORK_INDEX = 1
        const val THIRD_DEFAULT_MAIN_NETWORK_INDEX = 2
        const val FOURTH_DEFAULT_MAIN_NETWORK_INDEX = 3
        const val FIFTH_DEFAULT_MAIN_NETWORK_INDEX = 4
    }
}