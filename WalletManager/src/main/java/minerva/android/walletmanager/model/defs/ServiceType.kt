...
import minerva.android.walletmanager.model.defs.ServiceType.Companion.OAMTC
import minerva.android.walletmanager.model.defs.ServiceType.Companion.UNICORN_LOGIN

@Target(AnnotationTarget.TYPE, AnnotationTarget.VALUE_PARAMETER)
@Retention(AnnotationRetention.SOURCE)
@StringDef(UNICORN_LOGIN, M27, CHARGING_STATION, OAMTC)
annotation class ServiceType {
    companion object {
        ...
        const val OAMTC = "did:ethr:0x39fc0b7040cab1df11aba6a532ae7f429d2a7f75"
    }
}