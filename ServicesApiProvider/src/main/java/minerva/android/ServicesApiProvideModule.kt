...
import minerva.android.retrofit.ServicesRetrofitProvider
import org.koin.core.qualifier.named
import org.koin.dsl.module

fun createServicesApiProviderModule(isDebug: Boolean, baseUrl: String) = module {
    single(named(SERVICES_RETROFIT)) { ServicesRetrofitProvider.provideRetrofit(get(named(SERVICES_OKHTTP)), baseUrl) }
