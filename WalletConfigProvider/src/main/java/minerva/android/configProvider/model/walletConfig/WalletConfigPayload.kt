...
data class WalletConfigPayload(
    ...
    private var _erc20Tokens: Map<Int, List<ERC20TokenPayload>>? = mapOf() //TODO it will be splitted with Swarm implementation
) {
    val version: Int
    ...
    val erc20TokenResponse: Map<Int, List<ERC20TokenPayload>>
