...
interface CryptographyRepository {
    fun createMasterSeed(): Single<Triple<String, String, String>> //seed, publicKey, privateKey
    fun getMnemonicForMasterSeed(seed: String): String
    fun computeDeliveredKeys(seed: String, index: Int): Single<DerivedKeys>
    fun restoreMasterSeed(mnemonic: String): Single<Triple<String, String, String>> //seed, publicKey, privateKey
