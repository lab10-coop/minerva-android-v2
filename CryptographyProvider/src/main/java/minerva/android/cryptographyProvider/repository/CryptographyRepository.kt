...
interface CryptographyRepository {
    ...
    fun calculateDerivedKeys(seed: String, index: Int, derivationPathPrefix: String): Single<DerivedKeys>
    fun restoreMasterSeed(mnemonic: String, derivationPath: String): Single<Triple<String, String, String>> //seed, publicKey, privateKey
